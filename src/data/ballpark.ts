 ...
 *
 * It briefly took the sweep as an argument, for a dial that could be widened
 * past a semicircle to buy scale that width alone cannot. That went to the
 * phone and lost, so both the wider dial and the parameter are gone: a number
 * that can only ever be 180 is better named than passed.
 */
